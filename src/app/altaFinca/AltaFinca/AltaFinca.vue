      ...
      <v-row>
        <v-col :cols="posMap">
          <v-form dark ref="form" v-model="valid" :lazy-validation="lazy">
            <v-text-field v-model="nombre" :rules="nameRules" label="Nombre" clearable required></v-text-field>
            <v-text-field v-model="tamaño" label="Tamaño (opcional)" clearable></v-text-field>
            <v-select
              v-model="cultivo"
              :items="tiposCultivos"
