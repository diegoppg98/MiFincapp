...
export default {
  ...
  methods: {
    ...
    clickMuteItem(nombreClicked: { silenciated: boolean; iconSound: string; alerta: Alerta; }) {
      if (nombreClicked.silenciated) {
        nombreClicked.silenciated = false;
        nombreClicked.iconSound = 'mdi-volume-high';
      } else {
        nombreClicked.silenciated = true;
        nombreClicked.iconSound = 'mdi-volume-off';
      }
      nombreClicked.alerta.silenciada = nombreClicked.silenciated;
      FactoryAPI.getFactoryAPI('Firebase')
        .getAlerta()
        .updateAlert(nombreClicked.alerta)
        .then((result) => {
        ...
        if (result !== null) {
          result.forEach(function (childResult : Alerta) {
            ...
            items.push({
              ...
              src: image,
              alerta: childResult,
              silenciated: silenciado,
              iconSound: iconSilenciado,
            });
          });
        }
      });
